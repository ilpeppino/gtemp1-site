...
export const translations = {
  en: {
    meta: {
      title: "Gtemp1 — Digital products and app showcase",
      description: "Gtemp1 is an independent software studio building focused digital products, including LagaLaga.",
    },
    header: {
    ...
    hero: {
      ...
      titleLines: ["Focused products.", "Clear purpose.", "Built to grow."],
      description:
        "Gtemp1 builds practical digital products with strong usability and solid technical foundations. Explore the applications we are building today, starting with LagaLaga.",
      ctaPrimary: "Explore apps",
      ctaSecondary: "View LagaLaga",
    },
    features: {
      eyebrow: "What we build",
      title: "Products designed around real use cases",
      items: [
        {
          code: "FP",
          title: "Focused products",
          text: "Built to solve specific user problems clearly.",
        },
        {
          code: "CP",
          title: "Cross-platform experiences",
          text: "Designed for web and mobile where it adds value.",
        },
        {
          code: "UX",
          title: "Practical UX",
          text: "Simple flows, strong clarity, less friction.",
        },
        {
          code: "SF",
          title: "Scalable foundations",
          text: "Structured to evolve over time.",
        },
        {
          code: "TS",
          title: "Trust and support",
          text: "Clear legal and support paths for users.",
        },
        {
          code: "BI",
          title: "Built to improve",
          text: "Room for iteration, testing, and growth.",
        },
      ],
    },
    how: {
      eyebrow: "How we work",
      title: "From product idea to durable experience",
      steps: [
        { code: "01", title: "Identify", text: "Start from a real and specific need." },
        { code: "02", title: "Design", text: "Shape a focused and usable solution." },
        { code: "03", title: "Build", text: "Implement on strong technical foundations." },
        { code: "04", title: "Improve", text: "Evolve the product over time." },
      ],
    },
    useCases: {
      eyebrow: "Featured products",
      title: "Starting with LagaLaga",
      items: [
        {
          title: "LagaLaga",
          text: "A social gaming app built to help users organize and join Roblox sessions more easily.",
        },
        {
          title: "More apps coming",
          text: "Additional public products will be showcased here over time.",
        },
      ],
    },
    download: {
      eyebrow: "Get in touch",
      title: "Follow our products and what comes next",
      text: "Learn more about LagaLaga, explore our work, or contact Gtemp1 for support and collaboration-related questions.",
      ctaPrimary: "View LagaLaga",
      ctaSecondary: "Contact Gtemp1",
      footer: "More products will be added as they become public.",
    },
    footer: {
      privacy: "Privacy Policy",
      tos: "Terms of Service",
      copyright: "© 2026 Gtemp1",
    },
    privacy: {
